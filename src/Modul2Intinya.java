...
public class Modul2Intinya {
    private static ArrayList<Student> students = new ArrayList<>();
    private static ArrayList<Book> books = new ArrayList<>();
    private static Scanner scanner = new Scanner(System.in);
    public static void main(String[] args) {
        // Menambahkan buku ke dalam daftar buku
        books.add(new Book("388c-e681-9152", "How2Basic", "Vsauce", "Pendidikan", 3));
        books.add(new Book("ed90-be30-5cdb", "Hawwy potah", "Icewallowcome", "Horror", 2));
        books.add(new Book("d95e-0c4a-9523", "pen beli trek", "alul", "SciFi", 3));
